...
function readVecU8(buffer, offset) {
...
function readVecPubkey(buffer, offset) {
    const length = buffer.readUInt32LE(offset);
    offset += 4;
...
function readMessageSignature(buffer, offset) {
...
function readVecMessageSignature(buffer, offset) {
    const length = buffer.readUInt32LE(offset);
    offset += 4;
...
function decodeSignerRegistryType(value) {
    switch (value) {
        case 0: return 'VIA';
        case 1: return 'Chain';
...
module.exports = {
    ...
    readVecMessageSignature,
    decodeSignerRegistryType,
    getChainName
};